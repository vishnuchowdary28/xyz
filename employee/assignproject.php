	...
	<div class="divider"></div>
		...
		<table id="projectstatus">
			<tr>
				...
				<th align = "center" onclick="sortTable(0)">Project ID</th>
				<th align = "center" onclick="sortTable(1)">Emp. ID</th>
				<th align = "center" onclick="sortTable(2)">Project Name</th>
				<th align = "center" onclick="sortTable(3)">Due Date</th>
				<th align = "center" onclick="sortTable(4)">Submission Date</th>
				<th align = "center" onclick="sortTable(5)">Mark</th>
